...
inputSpec: ./specs/licence-api.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{6C6F202F-144E-49A7-B981-49FE07AB29DE}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<ILicenceApi>();
            IActivateLicenceApiResponse apiResponse = await api.ActivateLicenceAsync("todo");
            Licenza? model = apiResponse.Ok();
        }
...
- appName: Licence API
- appVersion: 1.0.0
- appDescription: API per la gestione delle licenze del client. Espone attivazione, rilascio di una nuova licenza e verifica dello stato corrente.
